...
public class SanitizedLoggingEvent implements ILoggingEvent {

    private final ILoggingEvent delegate;
    private final String sanitizedMessage;

    public SanitizedLoggingEvent(ILoggingEvent delegate, String sanitizedMessage) {
    ...
    @Override public String getMessage() { return sanitizedMessage; }
    @Override public Object[] getArgumentArray() { return delegate.getArgumentArray(); }
    @Override public String getFormattedMessage() { return sanitizedMessage; }
